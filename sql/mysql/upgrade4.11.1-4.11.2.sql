...
INSERT INTO config VALUES ('ShopFreightMethod','nERPCalculation');
...
INSERT INTO `scripts` (`script`, `pagesecurity`, `description`) 
	VALUES ('BankAccountUsers.php', '15', 'Maintains table bankaccountusers (Authorized users to work with a bank account in nERP)');
