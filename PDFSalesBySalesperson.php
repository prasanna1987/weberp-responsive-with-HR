...
if (sizeOf($Recipients) == 0) {
	...
	echo   prnMsg( _('There are no members of the Weekly Orders Recipients email group'), 'warn');
...
if (DB_error_no()!=0){
	include('includes/header.php');
	echo  prnMsg( _('An error occurred getting the orders details'),'error');
	if ($debug==1){
...
if($result){
		...
		include('includes/header.php');
		echo  prnMsg(_('The Weekly Orders report has been mailed'),'success');
		echo '<br /><p align="right"><a href="' . $RootPath . '/menu_data.php?Application=Sales" class="btn btn-default">' . _('<i class="fa fa-hand-o-left fa-fw"></i> To Menu') . '</a></p><br />';
		include('includes/footer.php');
		exit;
		...
		include('includes/header.php');
		echo  prnMsg(_('There are errors lead to mails not sent'),'error');
		echo '<br /><p align="right"><a href="' . $RootPath . '/menu_data.php?Application=Sales" class="btn btn-default">' . _('<i class="fa fa-hand-o-left fa-fw"></i> To Menu') . '</a></p><br />';
		include('includes/footer.php');
		exit;
