...
/* END Brought from class.pdf.php constructor */
	...
	if (DB_error_no() !=0) {
	  ...
	  include('includes/header.php');
	   ...
	   echo '<br /><p align="center"><a href="' . $RootPath . '/menu_data.php?Application=stock" class="btn btn-default">' . _('</i> Back to main Menu') . '</a></p>';
	   if ($debug==1){
	      echo '<br />' . $SQL;
	   }
...
<div class="form-group"> <label class="col-md-8 control-label">' . _('Duration of Buffer Stock to Hold') . '</label>
