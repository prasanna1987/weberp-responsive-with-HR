...
if (isset($_POST['DoIt']) AND IsEmailAddress($_POST['EmailAddr'])){
	...
	echo prnMsg(_('The email address does not appear to be a valid email address. The transaction was not emailed'),'warn');
}
...
echo '<tr><td>' . _('Email') . ' ' . $_GET['InvOrCredit'] . ' ' . _('Transaction Number:') . ' ' . $_GET['FromTransNo'] . ' ' . _('---to') . '</td>
