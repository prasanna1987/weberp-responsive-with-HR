...
if (isset($_POST['Submit'])) {
	...
	if ($_POST['TabCode'] == '' or $_POST['TabCode'] == ' ' or $_POST['TabCode'] == '  ') {
		$InputError = 1;
		echo prnMsg('<br />' . _('The Tab code cannot be an empty string or spaces'), 'error');
	...
	if (isset($SelectedTab) and $InputError != 1) {
		...
		if ($CheckRow[0] > 0) {
			$InputError = 1;
			echo prnMsg(_('The Tab ') . ' ' . $_POST['TabCode'] . ' ' . _(' already exists'), 'error');
		} else {
	...
	echo prnMsg(_('The Petty Cash Tab') . ' ' . $SelectedTab . ' ' . _('has been deleted'), 'success');
	unset($SelectedTab);
	unset($_GET['delete']);
}
...
<table id="general-table" class="table table-bordered">
		...
		while ($MyRow = DB_fetch_array($Result)) {
			...
			echo '<tr class="striped_row">
					...
					<td><a href="', htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'), '?SelectedTab=', $MyRow['tabcode'], '" class="btn btn-info">' . _('Edit') . '</a></td>
					<td><a href="', htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'), '?SelectedTab=', $MyRow['tabcode'], '&amp;delete=yes" class="btn btn-danger" onclick=\' return confirm("' . _('Are you sure you wish to delete this tab code?') . '", \'Confirm Delete\', this);\'>' . _('Delete') . '</a></td>
				</tr>';
		}
		//END WHILE LIST LOOP
...
if (!isset($_GET['delete'])) {
	...
	if (isset($SelectedTab) and $SelectedTab != '') {
		...
		echo '<div class="row">
<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">', _('Tab Code'), '</label>
					', $_POST['TabCode'], '</div>
				</div>';
	} else {
...
<div class="row">
<div class="col-xs-4">
<div class="form-group has-error"> <label class="col-md-8 control-label">', _('Tab Code'), '</label>
					<input type="text" class="form-control" required="required" maxlength="20" name="TabCode" /></div>
				</div>';
	}
...
<div class="form-group has-error"> <label class="col-md-8 control-label">', _('User Name'), '</label>
		<select required="required" class="form-control" name="SelectUser">';
	$SQL = "SELECT userid,
					realname
	...
	echo '<div class="col-xs-4">
<div class="form-group has-error"> <label class="col-md-8 control-label">', _('Type Of Tab'), '</label>
	...
	echo '<div class="row">
			<div class="col-xs-4">
<div class="form-group has-error"> <label class="col-md-8 control-label">', _('Currency'), '</label>
	...
	echo '<div class="col-xs-4">
<div class="form-group has-error"> <label class="col-md-8 control-label">', _('Limit Of Tab'), '</label>
			
				<input type="text" class="form-control" name="TabLimit" size="12" required="required" maxlength="11" value="', $_POST['TabLimit'], '" />
			</div>
		</div>';
	echo '<div class="col-xs-4">
<div class="form-group has-error"> <label class="col-md-8 control-label">', _('Cash Assigner'), '</label>
	...
	echo '<div class="row">
			<div class="col-xs-4">
<div class="form-group has-error"> <label class="col-md-8 control-label">', _('Authoriser - Cash'), '</label>
			<select required="required" class="form-control" name="SelectAuthoriserCash">';
	$SQL = "SELECT userid,
					realname
			FROM www_users
			ORDER BY userid";
	...
	echo '<div class="col-xs-4">
<div class="form-group has-error"> <label class="col-md-8 control-label">', _('Authoriser - Expenses'), '</label>
			<select required="required" class="form-control" name="SelectAuthoriserExpenses">';
	$SQL = "SELECT userid,
					realname
			FROM www_users
			ORDER BY userid";
	...
	echo '<div class="col-xs-4">
<div class="form-group has-error"> <label class="col-md-8 control-label">', _('GL Account Cash Assignment'), '</label>
			<select required="required" class="form-control" name="GLAccountCash">';
	...
	echo '<div class="row">
			<div class="col-xs-4">
<div class="form-group has-error"> <label class="col-md-8 control-label">', _('GL Account For Tab'), '</label>
			<select required="required" class="form-control" name="GLAccountPcashTab">';
	...
	$Result = DB_query($SQL);
	echo '<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">', _('Default Tag'), '</label>
			<select name="DefaultTag" class="form-control">';
