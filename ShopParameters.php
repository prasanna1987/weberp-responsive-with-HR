...
echo '</select></td>
		<td>' . _('Select the nERP service item to use for payment surcharges to be processed as') . '</td>
	</tr>';
...
$FreightMethods = array(array('MethodName'=>'No Freight','MethodCode'=>'NoFreight'),
						array('MethodName'=>'nERP calculation','MethodCode'=>'nERPCalculation'),
...
echo '</select></td>
		<td>' . _('Select the nERP bank account to use for receipts processed by Pay Pal') . '</td>
	</tr>';
...
echo '</select></td>
		<td>' . _('Select the nERP P/L account to use for commissions (transaction fees) charged by Pay Pal') . '</td>
	</tr>';
...
echo '</select></td>
		<td>' . _('Select the nERP bank account to use for receipts processed by credit card') . '</td>
	</tr>';
