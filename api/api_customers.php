...
/* Check that the currency code is set up in the nERP database */
...
/* Check that the sales type is set up in the nERP database */
...
/* Check that the hold reason is set up in the nERP database */
...
/* Check that the payment terms are set up in the nERP database */
...
/* Check that the customer type is set up in the nERP database */
...
/* Insert a new customer in the nERP database. This function takes an
...
/* Modifies a customer record in the nERP database. This function takes an
   associative array called $CustomerDetails, where the keys are the
   names of the fields in the debtorsmaster table, and the values are the
