<?php
	...
	$Parameter[1]['description'] = _('A valid nERP username. This user should have security access to this data.');
	$Parameter[2]['name'] = _('User password');
	$Parameter[2]['description'] = _('The nERP password associated with this user name. ');
	...
	$Description = _('This function is used to insert a new customer into the nERP database.');
...
/*x*/		}
	...
	$Description = _('This function is used to insert a new customer branch into the nERP database.');
...
/*x*/		}
	...
	$Description = _('This function is used to modify a customer which is already setup in the nERP database.');
	$Parameter[0]['name'] = _('Customer Details');
	$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ')
			._('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=debtorsmaster">' . _('here ') . '</a>'
			._('and are case sensitive. ')._('The values should be of the correct type, and the api will check them before updating the database. ')
			._('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.')
			 . '<p>' . _('The debtorno must already exist in the nERP database.');
	$Parameter[1]['name'] = _('User name');
	$Parameter[1]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[2]['name'] = _('User password');
	$Parameter[2]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/		}
	...
	$Description = _('This function is used to modify a customer branch which is already setup in the nERP database.');
	$Parameter[0]['name'] = _('Branch Details');
	$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ')
			._('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=custbranch">' . _('here ') . '</a>'
			._('and are case sensitive. ')._('The values should be of the correct type, and the api will check them before updating the database. ')
			._('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.')
			 . '<p>' . _('The branchcode/debtorno combination must already exist in the nERP database.');
	$Parameter[1]['name'] = _('User name');
	$Parameter[1]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[2]['name'] = _('User password');
	$Parameter[2]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/		}
	...
	$Parameter[0]['description'] = _('This is a string value. It must be a valid debtor number that is already in the nERP database.');
	$Parameter[1]['name'] = _('User name');
	$Parameter[1]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[2]['name'] = _('User password');
	$Parameter[2]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/		}
	...
	$Description = _('This function is used to retrieve the details of a customer branch from the nERP database.');
	$Parameter[0]['name'] = _('Debtor number');
	$Parameter[0]['description'] = _('This is a string value. It must be a valid debtor number that is already in the nERP database.');
	$Parameter[1]['name'] = _('Branch Code');
	$Parameter[1]['description'] = _('This is a string value. It must be a valid branch code that is already in the nERP database, and associated with the debtorno in Parameter[0]');
	$Parameter[2]['name'] = _('User name');
	$Parameter[2]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[3]['name'] = _('User password');
	$Parameter[3]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/		}
	...
	$Description = _('This function is used to retrieve the details of a customer from the nERP database.');
	$Parameter[0]['name'] = _('Debtor number');
	$Parameter[0]['description'] = _('This is a string value. It must be a valid debtor number that is already in the nERP database.');
	$Parameter[1]['name'] = _('User name');
	$Parameter[1]['description'] = _('A valid nERP username. This user should have security access  to this data.');
...
/*x*/		}
	...
	$Parameter[0]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[1]['name'] = _('User password');
	$Parameter[1]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/		}
	...
	$Description = _('This function is used to insert sales type details into the nERP database.');
...
/*x*/		}
	...
	$Description = _('This function inserts a new stock item into nERP, including updating the locstock table.');
...
/*x*/		}
	...
	$Description = _('This function modifies a stock item that already exists in nERP.');
	$Parameter[0]['name'] = _('Stock Item Details');
...
/*x*/		}
	...
	$Parameter[3]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[4]['name'] = _('User password');
	$Parameter[4]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/		}
	...
	$Parameter[4]['description'] = _('A valid nERP username. This user should have security access to this data.');
	$Parameter[5]['name'] = _('User password');
	$Parameter[5]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/	}
	...
	$Description = _('Creates a credit note from header details associative array and line items. This function implements most of a nERP credit note with the exception that it cannot handle serialised or lot/batch controlled items. All the necessary updates and inserts are handled for stock quantities returned, taxes, sales analysis, stock movements, sales and cost of sales journals');
...
/*x*/		}
	...
	$Description = _('This function is used to insert a new Sales Credit to the nERP database. Note that this function does not implement a nERP credit note in full and caution is advised in using this function. It does not handle tax at all, it does not add stockmovements, it does not update stock for any quantity returned or update sales analysis. To create a credit note using nERP logic use the CreateCreditNote function');
...
/*x*/		}
	...
	$Parameter[0]['description'] = _('An integer representing the nERP sales order number');
	$Parameter[1]['name'] = _('User name');
	$Parameter[1]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[2]['name'] = _('User password');
	$Parameter[2]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/		}
	...
	$Description = _('This function is used to insert a new supplier into the nERP database.');
...
/*x*/		}
	...
	$Description = _('This function is used to modify a supplier which is already setup in the nERP database.');
	$Parameter[0]['name'] = _('Supplier Details');
	$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ')
			._('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=suppliers">' . _('here ') . '</a>'
			._('and are case sensitive. ')._('The values should be of the correct type, and the api will check them before updating the database. ')
			._('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.')
			 . '<p>' . _('The supplierid must already exist in the nERP database.');
	$Parameter[1]['name'] = _('User name');
	$Parameter[1]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[2]['name'] = _('User password');
	$Parameter[2]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/		}
	...
	$Description = _('This function is used to retrieve the details of a supplier from the nERP database.');
	$Parameter[0]['name'] = _('Supplier ID');
	$Parameter[0]['description'] = _('This is a string value. It must be a valid supplier id that is already in the nERP database.');
	$Parameter[1]['name'] = _('User name');
	$Parameter[1]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[2]['name'] = _('User password');
	$Parameter[2]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/		}
	...
	$Parameter[5]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[6]['name'] = _('User password');
	$Parameter[6]['description'] = _('The nERP password associated with this user name. ');
	$ReturnValue[0] = _('If successful this function returns 0. ')
			._('Otherwise an array of error codes is returned. ');
...
/*x*/		}
	...
	$Description = _('This function is used to retrieve the details of a work order from the nERP database.');
	$Parameter[0]['name'] = _('Field name');
...
/*x*/		}
	...
	$Description = _('This function is used to insert new purchasing data into the nERP database.');
...
/*x*/		}
	...
	$Description = _('This function is used to modify purchasing data into the nERP database.');
	$Parameter[0]['name'] = _('Purchasing data');
	$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ')
			._('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=purchdata">' . _('here ') . '</a>'
			._('and are case sensitive. ')._('The values should be of the correct type, and the api will check them before updating the database. ')
...
/*x*/		}
	...
	$Description = _('This function is used to insert a new work order into the nERP database. Currently this works only for single line orders.');
...
/*x*/		}
	...
	$Description = _('Returns the nERP default date format');
	$Parameter[0]['name'] = _('User name');
	$Parameter[0]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[1]['name'] = _('User password');
	$Parameter[1]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/		}
	...
	$Description = _('Returns the nERP default shipper');
	$Parameter[0]['name'] = _('User name');
	$Parameter[0]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[1]['name'] = _('User password');
	$Parameter[1]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/		}
	...
	$Description = _('Returns the nERP default location');
	$Parameter[0]['name'] = _('User name');
	$Parameter[0]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[1]['name'] = _('User password');
	$Parameter[1]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/		}
	...
	$Description = _('Returns the nERP default price list');
	$Parameter[0]['name'] = _('User name');
	$Parameter[0]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[1]['name'] = _('User password');
	$Parameter[1]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/		}
	...
	$Description = _('Returns the nERP default inventory location');
	$Parameter[0]['name'] = _('User name');
	$Parameter[0]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[1]['name'] = _('User password');
	$Parameter[1]['description'] = _('The nERP password associated with this user name. ');
...
/*x*/					array($xmlrpcStruct,$xmlrpcString,$xmlrpcString));
	...
	$Description = _('Returns the nERP reports directory for the company selected');
	$Parameter[0]['name'] = _('User name');
	$Parameter[0]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[1]['name'] = _('User password');
	$Parameter[1]['description'] = _('The nERP password associated with this user name. ');
	...
	$Description = _('This function creates a POS data file on the nERP server for download by the POS');
	$Parameter[0]['name'] = _('POS Customer Code - a valid nERP customer that sales from the POS are made against.');
	$Parameter[0]['description'] = _('POS Customer Branch Code - a valid branch code of the nERP customer that the POS sales are made against');
	$Parameter[1]['name'] = _('User name');
	$Parameter[1]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[2]['name'] = _('User name');
	$Parameter[2]['description'] = _('A valid nERP username. This user should have security access  to this data.');
...
/*x*/		}
	...
	$Description = _('This function deletes a POS data file on the nERP server');
	$Parameter[0]['name'] = _('User name');
	$Parameter[0]['description'] = _('A valid nERP username. This user should have security access  to this data.');
	$Parameter[1]['name'] = _('User password');
	$Parameter[1]['description'] = _('The nERP password associated with this user name. ');
