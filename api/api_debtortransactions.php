...
/* Retrieves the default debtors code for nERP */
	...
	$Receipt contains an associative array in the format:
		 ...
		 * $Receipt['bankaccount'] - the nERP bank account
		 * $Receipt['reference']
		 * $Receipt['discountfx']
...
/*now enter the BankTrans entry */
	...
	function CreateCreditNote($Header,$LineDetails, $User, $Password) {
		...
		/* Create a customer credit note in nERP.
		 ...
		 * Header['shipvia'] - the shipper required by nERP
		 *
...
/* Create a customer invoice in nERP. This function will bypass the
 * normal procedure in nERP for creating a sales order first, and then
 * delivering it.
...
/* Create a customer credit note in nERP. This function will bypass the
 * normal procedure in nERP for creating a sales order first, and then
