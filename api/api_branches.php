...
/* Check that the area code is set up in the nERP database */
...
/* Check that the salesman is set up in the nERP database */
...
/* Check that the default location is set up in the nERP database */
...
/* Check that the tax group id is set up in the nERP database */
...
/* Check that the default shipper is set up in the nERP database */
