...
/* Check that the order type is set up in the nERP database */
...
/* Check that the from stock location is set up in the nERP database */
...
/* Create a customer sales order header in nERP. If successful
...
/* Modify a customer sales order header in nERP.
 */
...
/* Create a customer sales order line in nERP. The order header must
 * already exist in nERP.
 */
...
/* Modify a customer sales order line in nERP. The order header must
 * already exist in nERP.
 */
