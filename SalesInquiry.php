...
<div class="col-xs-12">';
 ...
 class="date" name="FromDate" size="11" maxlength="10" value="' . $_POST['FromDate'] . '" /></td>
			<td>' . _('To') . ':</td>
			<td><input type="text" class="form-control"
 class="date" name="ToDate" size="11" maxlength="10" value="' . $_POST['ToDate'] . '" /></td>
		</tr>';
	if(!isset($_POST['PartNumber'])) {
		$_POST['PartNumber']='';
	}
	echo '<tr>
			...
			<td>&nbsp;</td>
			<td><input type="text" class="form-control"
 name="PartNumber" size="20" maxlength="20" value="'. $_POST['PartNumber'] . '" /></td>
		</tr>';
	if(!isset($_POST['DebtorNo'])) {
		$_POST['DebtorNo']='';
	}
	echo '<tr>
			...
			<td>&nbsp;</td>
			<td><input type="text" class="form-control"
 name="DebtorNo" size="10" maxlength="10" value="' . $_POST['DebtorNo'] . '" /></td>
		</tr>';
	if(!isset($_POST['DebtorName'])) {
		$_POST['DebtorName']='';
	}
	echo '<tr>
			...
			<td>&nbsp;</td>
			<td><input type="text" class="form-control"
 name="DebtorName" size="30" maxlength="30" value="' . $_POST['DebtorName'] .'" /></td>
		</tr>';
    ...
    echo '<tr>
			...
			<td>&nbsp;</td>
			<td><input type="text" class="form-control"
 name="OrderNo" size="10" maxlength="10" value="' . $_POST['OrderNo'] . '" /></td>
		</tr>';
