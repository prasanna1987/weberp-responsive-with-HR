...
if (substr($LineText,0,4)==':20:'){ //Timestamp of report MT940 generation
	  ...
	  if (substr($LineText,0,5)==':60F:'){//The account opening balance
		 ...
		 if (!array_key_exists($_SESSION['Statement']->CurrCode,$CurrencyName)){
			echo prnMsg(_('The bank statement currency is a currency not defined in the system. Please see you system administrator'),'warn');
			echo prnMsg(_('The MT940 bank statement file cannot be imported and processed'),'error');
