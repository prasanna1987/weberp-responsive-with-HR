<?php
	...
	the syntax that nERP original reports were written in.
...
if (!class_exists('Cpdf', false)) {
	...
	/* Javier: Some scripts set the creator to be nERP like this
	...
	*/ 			$this->SetCreator(PDF_CREATOR);
			...
			if ($label == 'Author') {
	/* Javier: Many scripts set the author to be nERP like this
