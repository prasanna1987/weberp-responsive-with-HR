...
echo '<div class="block-header"><a href="" class="header-title-link"><h1>' . ' ' . _('Top Sales Items Inquiry') . '';
echo '</h1></a></div>';
...
echo '<div class="row">
		<div class="col-xs-3">
        <div class="form-group"> <label class="col-md-8 control-label">' . _('Range') . '</label>
	<br />
		<div class="radio">
...
echo '<div class="col-xs-3">
		...
		<div class="radio">
        <label for="example-radio1">
		<td><input type="radio" id="example-radio1" name="OrderBy" value="NetSales" ';
...
echo	' />' . _('Order By Net Sales') . '</label>
		...
		<div class="radio">
        <label for="example-radio2">
		<td><input type="radio" id="example-radio2" name="OrderBy" value="Quantity" ';
...
<input tabindex="4" type="submit" class="btn btn-success" name="ShowSales" value="' . _('Selecte creterias from above to view report') . '" />';
echo '</div>';
echo '</div>';
echo '</div>
      </form>
...
<div class="table-responsive">
	...
	echo '<td class="number" colspan="3">' . _('<strong>GRAND Total</strong>') . '</td>
