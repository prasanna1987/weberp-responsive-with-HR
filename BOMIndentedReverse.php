...
if (isset($_POST['PrintPDF'])) {
	...
	if ($ListCount == 0) {
			...
			include('includes/header.php');
			echo prnMsg(_('There were no items for the selected component'),'error');
...
<div class="form-group has-error"> <label class="col-md-8 control-label">' . _('Part') . '</label>
			<input type="text" autofocus-"autofocus" class="form-control" required="required" title="' ._('Enter the item code required to list the bill of material for') . '" name="Part" size="20" /></div>
		</div>
		<div class="col-xs-4">
