...
if (isset($_POST['submit']) OR isset($_POST['pdf']) OR isset($_POST['csv'])) {
	...
	if (isset($_POST['pdf'])) {
		...
		echo '<div class="row">' ._('From') . ':' . $_POST['FromDate'] . ' ' . _('to') . ' ' . $_POST['ToDate'] . '</div>';
		echo '<br />
...
<table id="general-table" class="table table-bordered">
	...
	if (isset($_POST['pdf'])) {
		...
		<input type="submit" class="btn btn-warning" name="pdf" value="' . _('Print as a pdf') . '" /></div>';
		echo '<div class="col-xs-4"><input type="submit" name="csv" class="btn btn-warning" value="' . _('Print as CSV') . '" />
              </div>
              </div><br />
...
<div class="form-group"> <label class="col-md-8 control-label">' . _('Asset Location') . '</label>
	...
	$result = DB_query($sql);
	echo '<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Asset') . '</label>
...
<div class="form-group has-error"> <label class="col-md-8 control-label">' . _(' From Date') . '</label>
			<input type="text" class="form-control input-datepicker-close" data-date-format="dd/mm/yyyy" id="example-datepicker" name="FromDate" required="required" title="' . _('Enter the start date to show the cost and accumulated depreciation from') . '" maxlength="10" size="11" value="' . $_POST['FromDate'] . '" /></div>
		</div>
		<div class="col-xs-4">
<div class="form-group has-error"> <label class="col-md-8 control-label">' . _('To Date ') . '</label>
			<input type="text" class="form-control input-datepicker-close" data-date-format="dd/mm/yyyy" id="example-datepicker" name="ToDate" required="required" title="' . _('Enter the end date to show the cost and accumulated depreciation to') . '" maxlength="10" size="11" value="' . $_POST['ToDate'] . '" /></div>
		</div> </div>
	
	<div class="row">
	<div class="col-xs-4">

		<input type="submit" name="submit" class="btn btn-info" value="' . _('Show Assets') . '" /></div>
		<div class="col-xs-4">
		<input type="submit" name="pdf" class="btn btn-warning" value="' . _('Print as a pdf') . '" /></div>
		<div class="col-xs-4">
		<input type="submit" name = "csv" class="btn btn-warning" value="' . _('Print as CSV') . '" />
	</div>
    </div><br />
