...
if(isset($_GET['DebtorNo'])) {
	...
	echo prnMsg(_('This script must be called with a customer code.'), 'info');
...
if (DB_num_rows($StockMovesResult) == 0) {
	echo '<br />';
	echo prnMsg(_('There are no items for this customer'), 'info');
	echo '<br />';
...
echo '<br /><div class="centre"><a href="SelectCustomer.php">' . _('Return to customer') . '</a></div><br />';
