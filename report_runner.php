...
// nERP. Much thanks to Phil Daintree as the major author of nERP.
//
// --------------------------------------------------------------------
// Written by Alan B Jones (mor3ton@yahoo.com)
// based on code orgiginally from nERP
// (c) alan jones 2006.
...
//$nERP_home=/srv/www/htdocs/nERP

$usage="USAGE\n".$argv[0].":\n".
       "     -r reportnumber (the number of the nERP report)\n".
       ...
       "     [ -H nERPHOME]  (the home directory for nERP - or edit the php file)\n";
...
if ($nERP_home=="") {
 	echo "nERP home is not set in this file or -H is not set";
}
// change directory to the nERP home to get all the includes to work nicely
chdir($nERP_home);
