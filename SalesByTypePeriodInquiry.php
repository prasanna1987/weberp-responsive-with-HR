...
echo '<div class="block-header"><a href="" class="header-title-link"><h1>' . ' ' . _('Sales Report') . '';
echo '</h1></a></div>';
...
echo '<div class="row">
		<div class="col-xs-4">';
echo '<div class="form-group"><label class="col-md-8 control-label">' . _('Range') . '</label><br />

		 <div class="radio"><label for="example-radio1">
		<input type="radio" id="example-radio1" name="DateRange" value="Custom" ';
if ($_POST['DateRange']=='Custom'){
	echo 'checked="checked"';
}
echo	' onchange="ReloadForm(Form1.ShowSales)"/>' . _('Custom Range') . '
		</label>
	</div>
	
	
		<div class="radio"><label for="example-radio2">
...
echo	' onchange="ReloadForm(Form1.ShowSales)" />' . _('This Week') . '</label>
	...
	<div class="radio"><label for="example-radio3">
		<input type="radio" id="example-radio3" name="DateRange" value="ThisMonth" ';
if ($_POST['DateRange']=='ThisMonth'){
	echo 'checked="checked"';
}
echo	' onchange="ReloadForm(Form1.ShowSales)" />' . _('This Month') . '</label>
		</div>
	<div class="radio"><label for="example-radio4">
		<input type="radio" id="example-radio4" name="DateRange" value="ThisQuarter" ';
...
if ($_POST['DateRange']=='Custom'){
	...
	echo '<div class="col-xs-2"><div class="form-group"><label class="col-md-8 control-label">' . _('Date From') . '</label>
	...
	echo '<div class="col-xs-2"><div class="form-group"><label class="col-md-8 control-label">' . _('Date To') . '</label>
...
echo '<div class="col-xs-4"><div class="form-group"><label class="col-md-8 control-label">' . _('Group By') . '</label><br />

		<div class="radio">
        <label for="example-radio1">
		<input type="radio" name="DisplayData" id="example-radio1" value="Daily" ';
if ($_POST['DisplayData']=='Daily'){
	echo 'checked="checked"';
}
echo	' onchange="ReloadForm(Form1.ShowSales)" />' . _('Daily') . '</label>
		</div>
	<div class="radio">
        <label for="example-radio2">
		<input type="radio" name="DisplayData" id="example-radio2" value="Weekly" ';
if ($_POST['DisplayData']=='Weekly'){
	echo 'checked="checked"';
}
echo	' onchange="ReloadForm(Form1.ShowSales)" />' . _('Weekly') . '</label>
		</div>
	<div class="radio">
        <label for="example-radio3">
		<input type="radio" name="DisplayData" id="example-radio3" value="Monthly" ';
if ($_POST['DisplayData']=='Monthly'){
	echo 'checked="checked"';
}
echo	' onchange="ReloadForm(Form1.ShowSales)" />' . _('Monthly') . '
		</label></div>
	<div class="radio">
        <label for="example-radio4">
		<input type="radio" name="DisplayData" id="example-radio4" value="Quarterly" ';
if ($_POST['DisplayData']=='Quarterly'){
	echo 'checked="checked"';
}
echo	' onchange="ReloadForm(Form1.ShowSales)" />' . _('Quarterly') . '</label>
		</div>';
echo '</div>
		</div></div>
	';
...
echo '<div class="row" align="center">
		<div><div class="form-group">
			<input tabindex="4" type="submit" name="ShowSales" class="btn btn-success" value="' . _('Select from above creterias  to view report') . '" />
		</div>
        </div>
		</div>
		</form>
...
if (isset($_POST['ShowSales'])){
	...
	if ($_POST['DateRange']=='Custom'){
		if (!Is_Date($_POST['FromDate'])){
			$InputError = 1;
			echo prnMsg(_('The date entered for the from date is not in the appropriate format. Dates must be entered in the format') . ' ' . $_SESSION['DefaultDateFormat'], 'error');
		}
