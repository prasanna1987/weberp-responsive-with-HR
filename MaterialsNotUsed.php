...
echo prnMsg(_('There is no Raw Material'),'error');
			  	
}
if (DB_num_rows($result) != 0){
	$TotalValue = 0;
	echo '<div class="block-header"><a href="" class="header-title-link"><h1>' . _('Raw Materials Not Used in any BOM') . '</h1></a></div>';
