...
if (isset($_POST['PrintPDF'])) {
	...
	if (DB_error_no() !=0) {
	  ...
	  include('includes/header.php');
	   echo prnMsg( _('The Indented BOM Listing could not be retrieved by nERP because') . ' '  . DB_error_msg(),'error');
...
<div class="form-group has-error"> <label class="col-md-8 control-label">' . _('Part') . '</label>
			<input type="text" class="form-control" name="Part" autofocus="autofocus" required="required" data-type="no-illegal-chars" title="' . _('Enter the item code of parent item to list the bill of material for') .  '" size="20" /></div>
		</div>
		<div class="col-xs-3">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Levels') . '</label>
