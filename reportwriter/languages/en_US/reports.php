...
define('RPT_IMP_ERMSG2',_('The filesize exceeds the MAX_FILE_SIZE directive in the nERP form.'));
...
define('RPT_IMP_ERMSG8',_('nERP could not find a valid report to import in the uploaded file!'));
