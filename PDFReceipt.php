...
/* Prints company logo */
$pdf->addJpegFromFile($_SESSION['LogoFile'], $XPos+20, $YPos-30, 0, 30);
...
$LeftOvers = $pdf->addTextWrap($Page_Width-$Right_Margin-180,$YPos-($line_height*4.5),140,$FontSize, _('Printed').' : ' . Date($_SESSION['DefaultDateFormat'] ));
$LeftOvers = $pdf->addTextWrap($Page_Width-$Right_Margin-180,$YPos-($line_height*6),140,$FontSize,  _('Page'). ': ' . $PageNumber);
