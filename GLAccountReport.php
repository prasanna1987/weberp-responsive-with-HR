...
<div class="form-group"> <label class="col-md-8 control-label">' . _('Select Accounts') . '</label>
		        <select name="Account[]" class="form-control" multiple="multiple">';
...
<div class="form-group"> <label class="col-md-8 control-label">' . _('For Period range').'</label>
			<select Name=Period[] multiple="multiple" class="form-control">';
...
<div class="form-group">
			<input type="submit" name="RunReport" class="btn btn-info" value="' ._('Print PDF'). '" />
		</div>
		</div>
		</div>
		</form></div></div>';
