...
if(isset($_POST['PrintPDF'])
	...
	if(DB_error_no() !=0) {
		...
		echo '<br /><p align="left"><a href="' . $RootPath . '/menu_data.php?Application=Sales" class="btn btn-default">' . _('Back to Menu') . '</a></p>';
	...
	while ($AgedAnalysis = DB_fetch_array($CustomerResult)) {
		...
		if($_POST['DetailedReport']=='Yes') {
			...
			if(DB_error_no() !=0) {
				...
				echo '<p align="right"><a href="' . $RootPath . '/index.php" class="btn btn-default">' . _('<i class="fa fa-hand-o-left fa-fw"></i> Menu') . '</a></p>';
	...
	if($ListCount == 0) {
		$Title = _('Aged Customer Account Analysis') . ' - ' . _('Problem Report') . '....';
		include('includes/header.php');
		echo prnMsg(_('There are no customers with balances meeting the criteria specified to list'),'info');
		echo '<p align="left"><a href="' . $RootPath . '/menu_data.php?Application=Sales" class="btn btn-default">' . _('Back to Menu') . '</a></p>';
...
<div class="form-group has-error"> <label class="col-md-8 control-label">' . _('From Customer Code') . '' . '</label>
				<input tabindex="1" autofocus="autofocus" class="form-control" required="required" type="text" maxlength="6" size="7" name="FromCriteria" value="0" title="' . _('Enter the first customer code alphabetically to include in the report') . '" /></div>
			</div>
			<div class="col-xs-4">
<div class="form-group has-error"> <label class="col-md-8 control-label">' . _('To Customer Code') . '' . '</label>
				<input tabindex="2" type="text" class="form-control" required="required"  maxlength="6" size="7" name="ToCriteria" value="zzzzzz" title="' . _('Enter the last customer code alphabetically to include in the report') . '" /></div>
			</div>
			<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Balance Type') . '' . '</label>
				<select tabindex="3" name="All_Or_Overdues" class="form-control">
		...
		if($_SESSION['SalesmanLogin'] != '') {
			...
			echo '<select tabindex="4" name="Salesman" class="form-control">';
		...
		echo '</div>
           ...
           <div class="form-group"> <label class="col-md-8 control-label">' . _('Currency') . '' . '</label>
				<select tabindex="5" name="Currency" class="form-control">';
		...
		echo '</select></div>
           ...
           <div class="form-group"> <label class="col-md-8 control-label">' . _('Report Type') . '' . '</label>
				<select tabindex="6" name="DetailedReport" class="form-control">
           ...
           <div class="form-group">
				<input tabindex="7" type="submit" class="btn btn-info" name="PrintPDF" value="' . _('Print PDF') , '" />
			</div>
            </div>
			</div>
            </form>
