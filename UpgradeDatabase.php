...
if (!isset($_POST['DoUpgrade'])){
	...
	if (!isset($_SESSION['VersionNumber'])){
		prnMsg(_('The nERP code is version')  . ' ' . $Version . ' ' . _('and the database version is not actually recorded at this version'),'info');
