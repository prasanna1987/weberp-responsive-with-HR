...
echo '<div class="block-header"><a href="" class="header-title-link"><h1> ', // Icon title.
	_('Pick Lists'), '</h1></a></div>';// Page title.
...
if (isset($PickList) and $PickList != '') {
	if (!is_numeric($PickList)) {
		echo prnMsg(_('The Pick List entered') . ' <u>' . _('MUST') . '</u> ' . _('be numeric'), 'error');
		unset($PickList);
	} else {
...
if (true or !isset($OrderNumber) or $OrderNumber == "") { //revisit later, right now always show all inputs
	...
	if (isset($SelectedStockItem) and $SelectedStockItem != '') {
		echo '<div class="row">
				<div class="col-xs-8"><p>', _('For the part'), ': <b>', $SelectedStockItem, '</b>', ' ', _('and'), '<input type="hidden" name="SelectedStockItem" value="', $SelectedStockItem, '" /></p></div></div>';
	}
echo '<div class="row">';
			
	echo '<div class="col-xs-4">
        <div class="form-group"> <label class="col-md-8 control-label">', _('Sales Order'), ':</label>
		<input name="OrderNumber" autofocus="autofocus" maxlength="8" class="form-control" size="9" value="', $OrderNumber, '"/></div></div>';
	echo '<div class="col-xs-4">
        <div class="form-group"> 
		<label class="col-md-8 control-label">', _('Pick List'), ':</label>
		<input name="PickList" maxlength="10" class="form-control" size="10" value="', $PickList, '"/></div>
		</div>
		';
	...
	echo '<div class="col-xs-4">
        <div class="form-group"> <label class="col-md-8 control-label">', _('Into Stock Location'), ':</label>
	...
	echo '</select></div></div>
		<div class="col-xs-4">
        <div class="form-group"> 
		<br /><input type="submit" class="btn btn-info" name="SearchPickLists" value="' . _('Search Pick Lists') . '" /></div></div>
		</div>
	';
}
...
<div class="col-xs-4">
        <div class="form-group"> 
		<label class="col-md-8 control-label">', _('Select a stock category'), ':</label>
...
echo '</select></div></div>
		<div class="col-xs-4">
        <div class="form-group"> 
		<label class="col-md-8 control-label">', _('Enter text extracts in the'), ' <b>', _('description'), '</b></label>
		<input type="text" name="Keywords" class="form-control" size="20" maxlength="25" /></div>
	</div>
	<div class="col-xs-4">
        <div class="form-group"> 
		<label class="col-md-8 control-label">', _('Enter extract of the'), '<b> ', _('Stock Code'), '</b></label>
	...
	<div class="row">
		<div class="col-xs-4">
        <div class="form-group"> 
				<input type="submit" name="SearchParts" class="btn btn-info" value="', _('Search Parts Now'), '" />
				</div>
				</div>
		<div class="col-xs-4">
        <div class="form-group"> 		
...
if (isset($StockItemsResult)) {
	...
	while ($MyRow = DB_fetch_array($StockItemsResult)) {
		echo '<tr class="striped_row">
				<td><input type="submit" name="SelectedStockItem" class="btn btn-info" value="', $MyRow['stockid'], '"</td>
