...
if (isset($WO) AND isset($StockId) AND $WO!=''){
	...
	if (DB_num_rows($resultItems) != 0){
		...
		echo   prnMsg(_('There were no items with ready to produce'),'info');
		prnMsg($sql);
		echo '<br /><p align="right"><a href="' . $RootPath . '/index.php" class="btn btn-default">' . _('<i class="fa fa-hand-o-left fa-fw"></i> To Menu') . '</a></p><br />';
