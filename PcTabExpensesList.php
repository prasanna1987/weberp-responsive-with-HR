...
function submit($TabToShow, $FromDate, $ToDate) {
	...
	if ($InputError == 0){
		...
		if (DB_num_rows($Result) != 0){
			...
			$objPHPExcel->getProperties()->setCreator("nERP")
										 ->setLastModifiedBy("nERP")
			...
			echo prnMsg('There is no data to export');
...
// the page is called.
	...
	include('includes/header.php');
echo '<div class="block-header"><a href="" class="header-title-link"><h1>' . ' ' . _('Excel file for Petty Cash Tab Expenses List') . '
		</h1></a></div>';
...
<div class="col-xs-12">';
	...
	echo '<div class="row">
<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Petty Cash Tab') . '</label>
...
<div class="form-group"> <label class="col-md-8 control-label">' . _('Date From') . '</label>
			<input type="text" class="form-control input-datepicker-close" data-date-format="dd/mm/yyyy" id="example-datepicker" name="FromDate" size="11" maxlength="10" value="' . $_POST['FromDate'] . '" /></div></div>
			<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">
			' . _('Date To') . '</label><input type="text" class="form-control input-datepicker-close" data-date-format="dd/mm/yyyy" id="example-datepicker" name="ToDate" size="11" maxlength="10" value="' . $_POST['ToDate'] . '" /></div>
		</div></div>';

	echo '<div class="row" align="center">
		<div>
<div class="form-group"> <input type="submit" name="submit" class="btn btn-success" value="' . _('Export to Excel') . '" /></div>
		</div>
		</div>
		<br />';
	echo '
