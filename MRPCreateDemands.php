...
if (isset($_POST['submit'])) {
   // Create mrpdemands based on sales order history
	...
	echo prnMsg( $TotalRecords . ' ' . _('records have been created'),'success');
...
<div class="form-group has-error"> <label class="col-md-8 control-label">' . _('Inventory Categories') . '</label>
		<select autofocus="autofocus" class="form-control" required="required" minlength="1" size="12" name="Categories[]"multiple="multiple">';
...
echo '<div class="row">
		<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">' . _('From Sales Date') . '</label>
		...
		<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">'. _('To Sales Date') . '</label>
<input type="text" class="form-control input-datepicker-close" data-date-format="dd/mm/yyyy" id="example-datepicker" name="ToDate" maxlength="10" size="11" value="' . $_POST['ToDate'] . '" /></div>
	...
	<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Start Date For Distribution') . '</label>
		<input type="text" class="form-control input-datepicker-close" data-date-format="dd/mm/yyyy" id="example-datepicker" name="DistDate" maxlength="10" size="11" value="' . $_POST['DistDate'] . '" /></div>
	</div></div>
	<div class="row">
	<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Distribution Period') . '</label>
		...
		<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Number of Periods') .'</label>
		<input type ="text" class="form-control" name="PeriodNumber" size="4" value="1" /></div>
	</div>
	<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Exclude Total Quantity Less Than') . '</label>
		<input type ="text" class="form-control" name="ExcludeQuantity" size="4" value="1" /></div>
    </div></div>
	
	<div class="row">
	<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Exclude Total Amount Less Than') . '</label>
		<input type ="text" class="form-control" name="ExcludeAmount" size="8" value="0" /></div>
	</div>
		<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Multiplier') .'</label>
		<input type="text" class="form-control" name="Multiplier" size="2" value="1" /></div>
	</div>
	<div class="col-xs-4">
