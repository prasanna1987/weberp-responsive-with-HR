...
<div class="form-group"><br />
		<input type="submit" name="PickSpec" value="' . _('Submit') . '" class="btn btn-info" />
		</div>
		</div>
		</div>
		</form>
...
if (DB_num_rows($result)==0){
	...
	include('includes/header.php');
	 echo '
			<br />';
	 echo prnMsg( _('Unable to Locate Specification') . ' : ' . $_SelectedProdSpec . ' ', 'error');
	echo '
				<div class="row">
					<p align="right"><a href="'. $RootPath . '/PDFProdSpec.php" class="btn btn-default">' . _('Product Specifications') . '</a></p></div>
