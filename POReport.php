...
<table id="general-table" class="table table-bordered">';
		...
		echo '<tr><th colspan="2">' . _('Report Creteria') . '</th></tr>';
		...
		echo '<tr><td>' . _('Stock Category') . '</td>
				<td>' . $_POST['Category'] . '</td></tr></table></div></div></div>';
				...
				while ($myrow = DB_fetch_array($result)) {
				   ...
				   // Detail for both DateType of Order
					printf('<tr class="striped_row">
							<td><a href="'. $RootPath . '/PO_OrderDetails.php?OrderNo=%s" class="btn btn-info">%s</a></td>
							<td>%s</td>
							<td>%s</td>
							<td>%s</td>
							<td>%s</td>
...
<div class="form-group"><input type="submit" name="submitcsv" class="btn btn-warning" value="' . _('Export to csv') . '" /></div>';
		echo '</div></div>
              </form></div></div>';
...
function submitcsv( $PartNumber,
	...
	if ($InputError !=1) {
		...
		fclose($FileHandle);
		echo '<div class="row"><h4 class="text-success"><strong>' . _('The report has been exported as a csv file.') . '</strong></h4>';
		echo '<p align="center"><a href="' .  $FileName . '" class="btn btn-info">' . _('Download') . '</a> ' . _('') . '</p></div>';
...
<div class="form-group has-error"> <label class="col-md-8 control-label">' . _('Report Type') . '</label>
			<select required="required" class="form-control" autofocus="autofocus" name="ReportType">
		...
		<div class="col-xs-3">
<div class="form-group has-error"> <label class="col-md-8 control-label">' . _('Date Type') . '</label>
			<select required="required" class="form-control" name="DateType">
...
<div class="form-group has-error"> <label class="col-md-8 control-label">' . _('Date From') . '</label>
			<input type="text" required="required" class="form-control input-datepicker-close" data-date-format="dd/mm/yyyy" id="example-datepicker" name="FromDate" size="11" maxlength="10" value="' . $_POST['FromDate'] .'" /> </div></div>
        <div class="col-xs-3">
<div class="form-group has-error"> <label class="col-md-8 control-label">' . _('Date To') . '</label><input type="text" required="required" class="form-control input-datepicker-close" data-date-format="dd/mm/yyyy" id="example-datepicker" name="ToDate" size="11" maxlength="10" value="' . $_POST['ToDate'] . '" /></div>
		</div>
		</div>
		<div class="row">
			<div class="col-xs-3">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Stock ID') . '</label>
			<select name="PartNumberOp" class="form-control">
				<option selected="selected" value="Equals">' . _('Equals') . '</option>
				<option value="LIKE">' . _('Begins With') . '</option>
				</select></div></div>
				<div class="col-xs-3">
<div class="form-group">
 <label class="col-md-8 control-label"><br /></label>
				<input type="text" name="PartNumber" size="20" maxlength="20" class="form-control" value="';
    if (isset($_POST['PartNumber'])) {
        echo $_POST['PartNumber'] . '" /></div>
			</div>';
	} else {
		echo '" /></div>
			</div>';
...
<div class="form-group"> <label class="col-md-8 control-label">' . _('Supplier Code') . '</label>
			<select name="SupplierIdOp" class="form-control">
				<option selected="selected" value="Equals">' . _('Equals') . '</option>
				<option value="LIKE">' . _('Begins With') . '</option>
				</select>
				</select></div></div>
...
<div class="form-group">
 <label class="col-md-8 control-label"><br /></label>
				<input type="text" name="SupplierId" class="form-control" size="10" maxlength="10" value="';
    if (isset($_POST['SupplierId'])) {
        echo $_POST['SupplierId'] . '" /></div>
				</div>';
	} else {
		echo  '" /></div>
			</div>';
...
<div class="form-group"> <label class="col-md-8 control-label">' . _('Supplier Name') . '</label>
			<select name="SupplierNameOp" class="form-control">
				<option selected="selected" value="LIKE">' . _('Begins With') . '</option>
				<option value="Equals">' . _('Equals') . '</option>
				</select>
				</div></div>
				<div class="col-xs-3">
<div class="form-group"> <label class="col-md-8 control-label"><br /></label>
<input type="text" name="SupplierName" class="form-control" size="30" maxlength="30" value="';
	if (isset($_POST['SupplierName'])) {
		echo $_POST['SupplierName'] . '" /></div>
			</div>';
	} else {
		echo  '" /></div>
			</div>';
	...
	echo '<div class="col-xs-3">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Order Number') . '
			' . _('Equals').'</label>
			<input type="text" class="form-control" name="OrderNo" size="10" maxlength="10" value="';
    if (isset($_POST['OrderNo'])) {
        echo $_POST['OrderNo'] . '" /></div>
				</div>';
	} else {
		echo  '" /></div>
				</div>';
	...
	echo '
			<div class="col-xs-3">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Line Item Status') . '</label>
			<select name="LineStatus" class="form-control">
	...
	<div class="row">
		<div class="col-xs-3">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Stock Categories') . '</label>
	...
	echo '</select></div>
		...
		<div class="col-xs-3">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Sort By') . '</label>
		...
		<div class="col-xs-3">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Summary Type') . '</label>
		...
		<div class="row">
			<div class="col-xs-3">
<div class="form-group"> <input type="submit" name="submit" class="btn btn-success" value="' . _('Show') . '" /></div></div>
		<div class="col-xs-3">
<div class="form-group"><input type="submit" name="submitcsv" class="btn btn-warning" value="' . _('Export to csv') . '" /></div></div>
		</div>
