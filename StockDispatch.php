...
if (isset($_POST['PrintPDF'])) {
	...
	if (DB_error_no() !=0) {
		...
		echo prnMsg( _('The Stock Dispatch report could not be retrieved by the querry because') . ' '  . DB_error_msg(),'error');
		echo '<br /><p align="right"><a href="' . $RootPath . '/menu_data.php?Application=stock" class="btn btn-default">' . _('Menu') . '</a></p>';
	...
	if (DB_num_rows($result) ==0) {
		...
		include('includes/header.php');
		echo '<br />';
		echo prnMsg( _('The stock dispatch did not have any items to list'),'warn');
		echo '<br /><p align="right"><a href="' . $RootPath . '/menu_data.php?Application=stock" class="btn btn-default">' . _('Menu') . '</a></p>';
...
/*Print out the grand totals */
	...
	include('includes/header.php');
	echo '<div class="block-header"><a href="" class="header-title-link"><h1>' . ' ' . _('Inventory Stock Dispatch Report') . '</h1></a></div>';
	...
	echo '<div class="row">
<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Dispatch Percent') . '</label>
			 <input type ="text" name="Percent" class="form-control" size="8" value="0" /></div>
		 </div>';
...
<div class="form-group"> <label class="col-md-8 control-label">' . _('To Stock Location') . '</label>
	...
	if (DB_num_rows($result1)==0){
		...
		echo '<br /><p><a href="' . $RootPath . '/StockCategories.php" class="btn btn-default>' . _('Define Stock Categories') . '</a></p>';
		echo '
			  </form>';
		include ('includes/footer.php');
		exit;
...
<div class="form-group"> <label class="col-md-8 control-label">' . _('In Stock Category') . '</label>
	...
	echo '
<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Dispatch Reason') . '</label>
...
<div class="form-group"> <label class="col-md-8 control-label">' . _('Report Type') . '</label>
	...
	echo '<div class="row">
	<div class="col-xs-4">
<div class="form-group"> <label class="col-md-8 control-label">' . _('Display Type') . '</label>
