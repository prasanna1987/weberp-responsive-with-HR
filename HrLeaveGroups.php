...
echo '<div class="block-header"><a href="" class="header-title-link"><h1>' . _('Employee Leave Group ') . '</h1></a></div>';
...
<div class="form-group"> <label class="col-md-12 control-label">' . _('Leave Group ID') . '</label> ' . $_POST['leavegroup_id'] . '</div></div></div>';
	} else 	{
	...
	echo '<div class="col-xs-4">
<div class="form-group has-error"> <label class="col-md-12 control-label">' . _('Leave Group Name') . '</label>
			<input type="text" name="LeaveGroupName"  class="form-control"  required="required" title="' . _('The Leave Group Name is required') . '" value="' . $_POST['LeaveGroupName'] . '" /></div></div>
			
		<div class="col-xs-4">
<div class="form-group"> <label class="col-md-12 control-label">' . _('Description ') . '</label>
				
<textarea name="GroupDescription"  title="' . _('The  Description is required') . '" class="form-control">' . $_POST['GroupDescription'] . '</textarea>
				</div></div>
