...
if (!isset($_POST['FromDate']) OR !isset($_POST['ToDate']) OR $InputError==1){
	...
	echo '<div class="block-header"><a href="" class="header-title-link"><h1>' . ' '
		. _('Delivery Differences Report') . '</h1></a></div>';
...
<div class="col-xs-12">';
	...
	echo '<div class="col-xs-4">
        <div class="form-group"> <label class="col-md-8 control-label">' . _('Inventory Category') . '</label>
			';
...
$ReportFileName = 'nERP' . '_DeliveryDifferences_' . date('Y-m-d').'.pdf';
